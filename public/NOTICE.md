...
|---|---|---|---|
| @bubblewrap/cli | 1.24.1 | Apache-2.0 | https://github.com/GoogleChromeLabs/bubblewrap |
| @grafana/faro-rollup-plugin | 0.5.1 | Apache-2.0 | https://github.com/grafana/faro-javascript-bundler-plugins |
| @grafana/faro-web-sdk | 2.2.4 | Apache-2.0 | https://github.com/grafana/faro-web-sdk |
